...
ax.set_ylabel('准确率', fontsize=14, fontweight='bold', fontproperties=chinese_font)
...
ax.legend(fontsize=11, prop=chinese_font)
...
# 设置刻度标签字体
ax.set_xticklabels(labels, fontproperties=chinese_font, fontsize=12)
ax.set_yticklabels(labels, fontproperties=chinese_font, fontsize=12, rotation=0)

ax.set_xlabel('预测类别', fontsize=14, fontweight='bold', fontproperties=chinese_font)
ax.set_ylabel('实际类别', fontsize=14, fontweight='bold', fontproperties=chinese_font)
ax.set_title('集成模型混淆矩阵', fontsize=16, fontweight='bold', pad=20,
             fontproperties=chinese_font)

# 设置colorbar标签
cbar = ax.collections[0].colorbar
cbar.set_label('样本数量', fontproperties=chinese_font, fontsize=12)
...
ax.text(1.5, -0.3, info_text, fontsize=11, fontproperties=chinese_font,
...
if os.path.exists('feature_importance.csv'):
    ...
    ax.set_xlabel('重要性得分', fontsize=12, fontweight='bold', fontproperties=chinese_font)
...
ax1.set_ylabel('准确率', fontsize=12, fontweight='bold', fontproperties=chinese_font)
ax1.set_title('模型优化过程', fontsize=14, fontweight='bold', fontproperties=chinese_font)
ax1.set_xticks(x)
ax1.set_xticklabels(stages, rotation=15, ha='right', fontproperties=chinese_font)
...
ax2.set_ylabel('准确率', fontsize=12, fontweight='bold', fontproperties=chinese_font)
ax2.set_title('不同采样策略对比', fontsize=14, fontweight='bold', fontproperties=chinese_font)
ax2.set_xticks(x2)
...
ax1.set_title('数据集划分', fontsize=14, fontweight='bold', fontproperties=chinese_font)
...
ax2.set_ylabel('样本数量', fontsize=12, fontweight='bold', fontproperties=chinese_font)
ax2.set_title('训练集类别分布', fontsize=14, fontweight='bold', fontproperties=chinese_font)
for i, v in enumerate(train_dist):
    ax2.text(i, v + 20, f'{v}\n({v/sum(train_dist)*100:.1f}%)', 
             ha='center', fontweight='bold', fontproperties=chinese_font)
ax2.grid(axis='y', alpha=0.3)
...
ax3.set_ylabel('样本数量', fontsize=12, fontweight='bold', fontproperties=chinese_font)
ax3.set_title('SMOTE数据平衡', fontsize=14, fontweight='bold', fontproperties=chinese_font)
ax3.set_xticks(x3)
ax3.set_xticklabels(labels, fontproperties=chinese_font)
...
ax4.set_ylabel('特征数量', fontsize=12, fontweight='bold', fontproperties=chinese_font)
ax4.set_title('特征工程进展', fontsize=14, fontweight='bold', fontproperties=chinese_font)
ax4.set_xticks(range(len(stages_feat)))
ax4.set_xticklabels(stages_feat, rotation=15, ha='right', fontproperties=chinese_font)
ax4.grid(alpha=0.3)
...
ax.set_title('模型性能指标雷达图', fontsize=14, fontweight='bold', pad=20,
             fontproperties=chinese_font)
ax.legend(loc='upper right', bbox_to_anchor=(1.3, 1.1), prop=chinese_font)
ax.grid(True)
